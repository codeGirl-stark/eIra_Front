...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-[9998] flex h-screen w-auto flex-col overflow-hidden bg-blue-950 text-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
      ...
      <div className="flex flex-col duration-300 ease-linear overflow-y-auto">
        ...
        <nav className="mt-5 py-4 lg:mt-9 xl:px-2">
          ...
          <div>
            ...
            <ul className="mb-6 pr-5 flex flex-col gap-1.5">
              {/* <!-- Menu Item Dashboard --> */}
              <li>
                <Link
              ...
              {/* <!-- End Menu Item Dossier patients --> */}
              ...
              <li>
                  <Link
                    href="../../medecin/ParametresDocteur"
                    className={`group relative flex items-center text-sm xl:text-base gap-2.5 rounded-lg px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-slate-700 focus:bg-slate-700 dark:hover:bg-meta-4 ${
                      pathname.includes('profile') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
              ...
              {/* <!-- Menu Item Logout --> */}
                <div className=" px-4 py-2 mt-[50%]">
                  <Link
                    href="/medecin/logout"
                    className={`mt-10 group relative flex items-center text-red-400 text-sm xl:text-base gap-2.5 px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out dark:hover:bg-meta-4 ${
                      pathname.includes('profile') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                      <svg
