...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-[9998] flex h-screen w-auto flex-col overflow-hidden bg-gray-800 text-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5 flex text-xs xl:text-sm flex-col gap-2.5 pl-3 ml-10 text-gray-400 border-l-2">
                            ...
                            <li>
                              <Link
                                href="../../institution/listeAssistants"
                                className='hover:text-white focus:text-white'
                              >
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5 flex text-xs xl:text-sm flex-col gap-2.5 pl-3 ml-10 text-gray-400 border-l-2">
                            <li>
                              <Link
                                href="../../institution/listePatients"
                                className='hover:text-white focus:text-white'
                              >
                                  Tous les patients
                              </Link>
