    ...
    return (
        <>
                <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
                    ...
                    <span className="hidden text-right lg:block">
                        {user? (
                            <>
                                ...
                                <span className="block text-xs dark:text-white">Email</span>
                            </>}
                    </span>
                    ...
                    <svg
                    className="hidden fill-current dark:text-white sm:block"
                    width="12"
                    height="8"
                    viewBox="0 0 12 8"
                    fill="none"
                ...
                {dropdownOpen && (
                    <div
                    className={`absolute right-0 mt-4 flex w-auto lg:w-auto flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-gray-700 dark:text-white`}
                    >
                    <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-8 dark:border-strokedark">
                    <li>
                        <Link
                            href="../../institution/profilInstitu"
