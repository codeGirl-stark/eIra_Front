...
export default function Step1({ formData, handleChange,handleCheckboxChange, nextStep }) {
      ...
      <>
        <div className="flex flex-col lg:flex-row lg:gap-10">
            <div className="w-full ">
                ...
                {/* FIN SECTION INFORMATIONS GÉNÉRALES */}
            </div>
                        ...
                        <div className="flex flex-col gap-5 p-10">   
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {CIRCONSTANCE_OPTIONS.map((option) => (
                                        <div key={option.value} className="flex items-center">
                                            <input
                                                ...
                                                id={option.value}
                                                value={option.value}
                                                checked={formData.circonstance.includes(option.value)}
                                                onChange={(e) => {
                                    ...
                                    {formData.circonstance.includes("Autres") && (
                                        <div className="mt-4">
                                            <label
                                                htmlFor="otherText"
