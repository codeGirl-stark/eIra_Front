...
const VisitesByDate = () => {
    ...
    useEffect(() => {
        const fetchAllVisites = async () => {
            ...
            if (!access) {
                router.push("/institution/doctorLogin");
                return;
            }
                    ...
                    <thead>
                      ...
                      {currentPatients.map((visite: VisiteInterface, index:number) => (
                          <tr key={visite.id}>
                              ...
                              <td className="border-b border-[#eee] dark:border-gray-500 py-5 px-5 dark:text-white xl:pl-11">
                                  <div className="flex items-center space-x-3">
                                      <Link href={`/institution/Visite/${visite.id}`}>
