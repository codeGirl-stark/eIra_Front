...
export const UpdateAssistant: React.FC = () => {
    ...
    const handleSubmit = async (e:any) => {
        ...
        axios.patch(`${apiUrl}/admin_app/assistants/${id}/`, form,{
            headers: {
                'Content-Type': 'multipart/form-data',
        ...
        .then(() =>{
            ...
            router.push(`/institution/listeAssistants`)
        })
        .catch(error =>{
    ...
    return loading ? (
        ...
        <DefaultLayout>
            <Breadcrumb pageName={`Détails du compte de l'assistant ${formData.username}`} />

            <Link href="/institution/listeAssistants">
                <button 
                    type="button"
