...
export const ProfilMedecin: FC = () => {
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            ...
            axios.get(`${apiUrl}/institution/profileInstitu/`, {
                headers: {
    ...
    const InfohandleSubmit = async (event: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
        ...
        for (const key in profile) {
            form.append(key, profile[key as keyof Profil] as Blob | string);
        }

        if (profileExists) {
            // Mettre à jour le profil existant
            axios.put(`${apiUrl}/institution/profileInstitu/`, form, {
                headers: {
                    'Content-Type': 'multipart/form-data',
            ...
            axios.post(`${apiUrl}/institution/profileInstitu/`, form, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                    Authorization: `Bearer ${access}`,
                },
    ...
    const handleDelete = async () => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer votre profil ?")) {
            ...
            await axios.delete(`${apiUrl}/institution/profileInstitu/`, {
                headers: {
                    'Content-Type': 'multipart/form-data',
    ...
    */
    ...
    return loading ? (
        ...
        <DefaultLayout>
            <Breadcrumb pageName="Profil de l'institution" />
