...
export const AdminDashboard: React.FC = () =>  {
  ...
  useEffect(() => {
    const fetchStatistiques = async () => {
        ...
        await axios.get(`${apiUrl}/institution/statInstitu/`, {
            headers: {
                'Content-Type': 'multipart/form-data',
            ...
            .catch(error =>{
              alert(error?.response?.data?.erreur || "Aucune statisque !");
                console.log(error)
            })
    }
    ...
    const userDistributionData = {
        labels: ['Médecins', 'Assistants'],
        datasets: [{
            data: [stats?.total_doctors,stats?.total_assistants],
            backgroundColor: ['khaki','maroon',],
        }],
    };
    ...
    const resourceData = {
        ...
        datasets: [{
            ...
            backgroundColor: ['pink','indigo', 'coral', 'orange'],
        }],
    };
            ...
            {stats && stats.total_users > 0  ?(
              <>
                ...
                <div className="mt-5 grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-6 xl:grid-cols-2 2xl:gap-7.5">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950 p-5 rounded-lg shadow-md">
                        <h2 className="text-slate-400 text-xs font-bold">Utilisateurs actifs/inactifs</h2>
