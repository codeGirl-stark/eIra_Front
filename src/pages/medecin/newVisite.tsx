        ...
        const fetchPatient = async () => {
            ...
            await axios.get(`${apiUrl}/dossier_medical/patient/`, {
                ...
                .catch(error =>{
                    ...
                    if (status === 404 || message === "Patient introuvable ou non associé au médecin connecté.") {
                        // Redirection vers la page de création avec l'ID du patient
                        router.push(`/medecin/newPatient`);
                    } else {
                        alert(message || "Échec de récupération des patients !");
                        console.log(error);
                    }
                })
        }
                            ...
                            <div className="rounded-lg border border-gray-500 bg-white shadow-lg p-6 dark:border-gray-600 dark:bg-blue-950">
                                ...
                                <div className="flex flex-col gap-5 p-10">
                                    ...
                                    <div className="flex flex-col lg:justify-between">  
                                        <Link href="/medecin/newPatient" className="dark:text-white flex mb-5 ">
                                            <svg 
