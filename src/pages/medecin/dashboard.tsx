...
interface DefaultInterface {
  total_assistants: { count: number; percentage: number };
        ...
        {statistiques && statistiques.total_patients.count > 0  ?(
          <>
            <div className="mb-5 grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-6 xl:grid-cols-2 2xl:gap-7.5">
              <CardDataStats title="Assistant total en charge" total={statistiques.total_assistants.count.toString()} rate={`${statistiques.total_assistants
                .percentage} %`}>
                <svg 
