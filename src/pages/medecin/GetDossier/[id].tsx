...
import Etape1 from "../../../components/medecinComponents/UpdateDossier/etape1";
import Etape2 from "../../../components/medecinComponents/UpdateDossier/etape2";
import Etape3 from "../../../components/medecinComponents/UpdateDossier/etape3";
import Etape4 from "../../../components/medecinComponents/UpdateDossier/etape4";
import Etape5 from "../../../components/medecinComponents/UpdateDossier/etape5";
import Etape6 from "../../../components/medecinComponents/UpdateDossier/etape6";
...
export const GetDossier: React.FC = () => {
        ...
        const fetchDossier = async () => {
            ...
            await axios.get(`${apiUrl}/dossier_medical/dossier/${id}/`, {
                ...
                .catch(error =>{
                    ...
                    if (status === 404 || message === "Dossier médical introuvable.") {
                        // Redirection vers la page de création avec l'ID du patient
                        router.push(`/medecin/Dossiers/${id}`);
                    } else {
                        alert(message || "Échec de récupération du dossier !");
                        console.log(error);
                    }
                })
        }
    ...
    const handleSubmit = async (e: any) => {
        ...
        axios
            ...
            .then(() => {
                ...
                router.push("/medecin/listePatients");
            })
            .catch((error) => {
    ...
    return loading ? (
        ...
        <DefaultLayout>
            ...
            <Link href="/medecin/listePatients">
                <button 
                    type="button"
