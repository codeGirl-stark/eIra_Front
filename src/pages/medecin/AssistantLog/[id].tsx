...
export const AssistantLog: React.FC = () => {
    ...
    useEffect(() => {
        const fetchLogs = async () => {
            ...
            await axios.get(`${apiUrl}/assistant/assistantIdLog/${id}/`, {
                headers: {
    ...
    return loading ? (
        ...
        <DefaultLayout>
            <Breadcrumb pageName="Actions de l'assistant" />
            
            <Link href={`/medecin/Assistant/${id}`}>
                <button 
                    type="button"
