...
export const ProfilMedecin: FC = () => {
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            ...
            axios.get(`${apiUrl}/assistant/profile/`, {
                headers: {
    ...
    const InfohandleSubmit = async (event: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
        ...
        if (profileExists) {
            ...
            axios.put(`${apiUrl}/assistant/profile/`, form, {
                headers: {
                    'Content-Type': 'multipart/form-data',
            ...
            axios.post(`${apiUrl}/assistant/profile/`, form, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                    Authorization: `Bearer ${access}`,
                },
    ...
    const handleDelete = async () => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer votre profil ?")) {
            ...
            await axios.delete(`${apiUrl}/assistant/profile/`, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                                    ...
                                    <div className="flex flex-row">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                name="is_active"
                                                value={profile.is_active?"oui":"non"}
                                                readOnly
