...
export const ParamètresAdmin: FC = () => {
    ...
    const [profile, setProfile] = useState<User>({
     ...
     useEffect(() => {
        ...
        .catch(error =>{
            alert(error?.response?.data?.erreur || "Erreur de la récupération des données !");
            console.log(error);
        })
        };
    ...
    */
    ...
    useEffect(() => {
        const fetchProfilePicture = async () => {
            ...
            .catch(error =>{
                alert(error?.response?.data?.erreur || "Erreur de récupération de la photo !");
                            ...
                            <div className="border-b border-gray-400 py-4 px-6 dark:border-slate-500">
                                ...
                                <div className="flex flex-col gap-5 p-10">
                                    ...
                                    <div className="flex justify-between">
                                        <Link href="/admin/changePassword" className="dark:text-white flex ">
                                            <svg 
