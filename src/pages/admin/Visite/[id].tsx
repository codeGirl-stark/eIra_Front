...
export const DetailVisite: React.FC = () => {
            ...
            await axios.get(`${apiUrl}/dossier_medical/Allpatients/`, {
                ...
                .then(response =>{
                    if (response.data.length === 0) {
                       alert("Aucun patient enregistré")
                    } else {
    ...
    return loading ? (
        ...
        <DefaultLayout>
            <Breadcrumb pageName="Détails de la visite" />

            <Link href="/admin/allVisites">
                <button 
                    type="button"
