...
export const UpdateInstitution: React.FC = () => {
    ...
    useEffect(() => {
        const fetchInstitution = async () => {
            ...
            await axios.get(`${apiUrl}/admin_app/institutions/${id}/`, {
                headers: {
    ...
    const handleSubmit = async (e:any) => {
        ...
        axios.patch(`${apiUrl}/admin_app/institutions/${id}/`, form,{
            headers: {
                'Content-Type': 'multipart/form-data',
        ...
        .then(() =>{
            ...
            router.push(`/admin/listeInstitu`)
        })
        .catch(error =>{
    ...
    return loading ? (
        ...
        <DefaultLayout>
            <Breadcrumb pageName={`Détails des informations de l'institution ${formData.username}`} />

            <Link href="/admin/listeInstitu">
                <button 
                    type="button"
                                ...
                                <div className="flex flex-col gap-5 p-10">
                                    ...
                                    <div >
                                        <label className="label ">
                                            <span className="label-text text-sm text-black dark:text-white mr-5">Statut actif de l&apos;institution</span>
                                            <input 
                                                type="checkbox" 
                                                name="is_active"
