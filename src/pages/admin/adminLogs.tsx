                                ...
                                <table className="w-full table-auto">
                                    <thead>
                                        <tr className="bg-blue-50 text-left dark:bg-slate-900">
                                            ...
                                            <th className="min-w-[150px] py-4 px-4 font-medium text-center lg:text-base text-black dark:text-white">
                                                Numéro
                                            </th>
                                            <th className="min-w-[150px] py-4 px-4 font-medium text-center lg:text-base text-black dark:text-white">
                                                Date d&apos;enregistrement
                                            </th>
                                            <th className="min-w-[120px] py-4 px-4 font-medium text-center lg:text-base text-black dark:text-white">
                                                Libellé
                                            </th>
                                            <th className="min-w-[120px] py-4 px-4 font-medium  text-center lg:text-base text-black dark:text-white">
                                                Utilisateur
                                        ...
                                        <tr key={log.id}>
                                            ...
                                            <td className="border-b border-[#eee] py-5 px-4 dark:border-gray-500 sm:text-sm">
                                                <p className="text-black text-center dark:text-white font-bold">
                                                    {indexOfFirstLog + index + 1} {/* Correction de l'index */}
                                                </p>
                                            </td>
